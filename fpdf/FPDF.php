...
function FPDF($orientation='P', $unit='mm', $format='A4')
{
	...
	//Page format
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,860.89), 'a5'=>array(420.94,595.28),
...
function Header()
{
    ...
    //echo pathinfo(__FILE__,0);
    $imagem_esquerda = "../imagens/logo.jpg";
	...
	if($print_header)
	{
		...
		if($this->CurOrientation == 'L')
		{
			...
			{
				if($imagem_esquerda != '')
					$this->Image($imagem_esquerda,15,10,65,15);
		...
		else
		{
		  if($imagem_esquerda != '' || $imagem_direita != '')
			{
				if($imagem_esquerda != '')
					$this->Image($imagem_esquerda,12,19,18);
					//$this->Image($imagem_esquerda,177,16,18);
				if($imagem_direita != '')
					$this->Image($imagem_direita,177,10,10);
		...
		//echo '3';
			...
			$this->Cell(0,5,$subcabecalho,'B',0,'0');				
			$this->Ln(5);
			$this->SetY($y+12);
		}
